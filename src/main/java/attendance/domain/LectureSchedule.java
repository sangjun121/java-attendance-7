...
public enum LectureSchedule {
    MONDAY("월", LocalTime.of(8, 00), LocalTime.of(23, 00)),
    TUESDAY("화", LocalTime.of(8, 00), LocalTime.of(23, 00)),
    WEDNESDAY("수", LocalTime.of(8, 00), LocalTime.of(23, 00)),
    THURSDAY("목", LocalTime.of(8, 00), LocalTime.of(23, 00)),
    FRIDAY("금", LocalTime.of(8, 00), LocalTime.of(23, 00));
